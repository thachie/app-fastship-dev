...
return [
    ...
    */
    ...
    'production' => [
        'credentials' => [
            'devId' => env('EBAY_PROD_DEV_ID','35eeac4e-6006-41d9-adee-c4becc11ba46'),
            'appId' => env('EBAY_PROD_APP_ID','TUFFComp-CloudCom-PRD-1ab9522e2-1a463403'),
            'certId' => env('EBAY_PROD_CERT_ID','PRD-ab9522e246d1-1a9b-4fc5-b633-aad6'),
        ],

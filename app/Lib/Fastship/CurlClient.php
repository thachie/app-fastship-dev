    ...
    public function handleCurlError($errno, $message)
    {
        ...
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Fastship ($apiBase).";
                break;
            default:
                $msg = "Unexpected error communicating with Fastship.  " . "If this problem persists,";
        }

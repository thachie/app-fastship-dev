        ...
        <form name="register_form" class="form-horizontal regis" method="post" action="{{url ('/customer/register')}}">	                        
	        ...
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body">				
                    <div class="col-md-6">
                        <input type="text" class="form-control required" placeholder="{!! FT::translate('placeholder.firstname') !!}" name="firstname" id="firstname" required>
                    </div>
                    
                    <div class="col-md-6">
                        <input type="text" class="form-control required" placeholder="{!! FT::translate('placeholder.lastname') !!}" name="lastname" id="lastname" required>
                    </div>
                    
                    <div class="col-md-6">
                        <input type="text" class="form-control required" placeholder="{!! FT::translate('placeholder.email') !!}" name="email" id="email" required>
                    </div>
                                
                    <div class="col-md-6">
                        <input type="text" class="form-control required" placeholder="{!! FT::translate('placeholder.telephone') !!}" name="telephone" id="telephone" required>
                    </div>  
                    ...
                    <div class="col-md-6">
                        <input type="hidden" class="form-control" placeholder="รหัสอ้างอิง" name="referal_code" id="referal_code" value="FSXEBAY" />
                    </div>

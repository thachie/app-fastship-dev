...
<div class="conter-wrapper">
	...
	<div class="row">
		<div class="col-md-8">
			<form id="shipment_form" name="shipment_form" role="form"  class="form-horizontal" method="POST" action="{{url ('shipment/create_ebay')}}">
    			{{ csrf_field() }}
									...
									<tr id="import_form0">
										...
										<td style="">
			                                ...
			                                <div id="ebayId_<?=$ebayId;?>">
				                                <form id="ebay_create_shipment_<?=$val['ebay_id'];?>" class="form-horizontal" method="post" action="{{url ('shipment/ebay/'.$ebayId)}}">
													{{ csrf_field() }}

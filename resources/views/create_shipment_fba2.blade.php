		...
		<div class="col-md-6 col-xs-12">
			...
			<div class="panel panel-primary">
            	...
            	<div class="panel-body row-no-padding">
        			...
        			<div class="form-group">
                        <label class="col-md-3 control-label" style="margin-top: 0;">Receiver Name</label>
                        <div class="col-md-8">
                        	<input type="text" name="receiver_firstname" id="receiver_firstname" placeholder="" title="ReceiverFirstname" class="form-control required" value="{{ old('receiver_firstname',$customerName) }}" required />
                        </div>
        			</div>

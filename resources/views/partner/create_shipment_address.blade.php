            ...
            <div class="col-md-6" >
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body row-no-padding">
                        ...
                        <div class="form-group col-md-6">
                            <input name="city" type="text" placeholder="City" class="form-control required input-count" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="50" value="<?php echo $default['receiver']['city']; ?>" />
                        ...
                        <div class="form-group col-md-6">
                            <input name="state" type="text" placeholder="State" class="form-control required input-count" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="50" value="<?php echo $default['receiver']['state']; ?>" />

							...
							<div class="invoice">
								...
								<div class="row">
									<div class="col-md-7 col-print-7">
										...
										<?php if($customer_data->CUST_COMPANY): ?>
											{{ $customer_data->CUST_COMPANY }} <br />
											เลขประจำตัวผู้เสียภาษี {{ $customer_data->CUST_TAXID }} 
										<?php else: ?>
										{{ $customer_data->CUST_FIRSTNAME }} {{ $customer_data->CUST_LASTNAME }}
										<?php endif; ?>
										 <br />
										 
										{{ $customer_data->CUST_ADDR1 }} {{ $customer_data->CUST_ADDR2 }} 
										{{ $customer_data->CUST_CITY }} {{ $customer_data->CUST_STATE }} {{ $customer_data->CUST_POSTCODE }} <br />
										โทร. {{ $customer_data->CUST_TEL }} อีเมล์ {{ $customer_data->CUST_EMAIL }} <br />
									</div>

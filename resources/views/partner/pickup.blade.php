...
<?php //alert($rates); ?>
    ...
    <?php if(sizeof($shipment_data) > 0){ ?>
        ...
        <form id="pickup_form" class="form-horizontal" method="post" action="{{url ('partner/pickup-create')}}">
	       {{ csrf_field() }}
           <input type="hidden" name="coupon_code" id="coupon_code" value="" />
           <input type="hidden" name="payment_method" value="Invoice" />
           <input type="hidden" name="action" value="partner_pickup" />
        ...
        <div class="row">
                ...
                <div class="panel-body">
                    <table class="table table-stripe table-hover">
                        ...
                        <tr id="shipment_<?php echo $data['ID'];?>">
                            <td><a href="{{ url('partner/api/get/shipment_detail/'.$data['ID']) }}" target="_blank"><?php echo $data['ID'];?></a></td>
                    ...
                    <div class="col-md-12 text-center"><a href="{{ url('partner/create-shipment') }}">+ สร้างพัสดุเพิ่ม</a></div>
                </div>
            </div>
            </div>
            ...
            <div class="panel panel-primary">
	            ...
	            <div class="col-xs-12 shipment-list">
	            	<div class="col-xs-12">
	                    <div class="pull-left"><h4><a href="{{ url('partner/api/get/shipment_detail/'.$data['ID']) }}" target="_blank"><?php echo $data['ID'];?></a></h4></div>
                            ...
                            <fieldset>
                                ...
                                <label for="drop-thaipost">
                                    ...
                                    <div class="col-8 col-xs-7 text-left">
                                        ...
                                        <p class="slogan col-md-6 no-padding"><?php echo $rates['Drop_AtThaiPost']['AccountRate']; ?> บาท</p>
                                ...
                                <label for="drop-4">
                                    ...
                                    <div class="col-8 col-xs-7 text-left">
                                        ...
                                        <p class="slogan col-md-6 no-padding">ฟรี</p>
                                        <div class="text-right col-md-6">
                                            <button type="button" class="btn btn-xs btnmodal" data-toggle="modal" data-target="#ModalB24">
                                            	<i class="fa fa-info-circle"></i> รายละเอียดเพิ่มเติม
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body sumpickbody">
                            ...
                            <div class="row" id="pickupcost" >
                                <div class="col-md-5 col-xs-6 text-right">ค่าบริการเพิ่มเติม</div>
                                <div class="col-md-3 col-xs-4 text-right" id="cost"></div>
                                <div class="col-md-4 col-xs-2">บาท</div>
                            </div>
                            <!--<div class="row" id="couponcode">
                                <div class="col-md-5 col-xs-6 text-right">คูปองส่วนลด</div>
                                ...
                                <div class="col-md-3 col-xs-2 "><input type="button" value="Use Code" class="btn btn-sm" onclick="getCouponDiscount();" /></div>
                            </div>-->
                            ...
                            <!--<div class="radio text-center">
                                ...
                                <div class="col-md-7 col-xs-12">
                                    ...
                                    <label><input type="radio" name="payment_method" id="Credit_Card" value="Credit_Card" <?php if(!isset($credit) || !$credit){ echo "disabled"; }?>>ชำระผ่านบัตรเครดิต</label>
                                </div>
                            </div>-->
                            <!-- <div class="radio text-center">
                                    <label>วิธีการชำระเงิน </label>
        ...
        <div class="modal fade" id="ModalTP" tabindex="-1" role="dialog" aria-labelledby="ModalTP_Label" aria-hidden="true">
        	<div class="modal-dialog">
            	<div class="modal-content">
                	...
                	<div class="modal-body text-center">
						<p>ลูกค้าสามารถนำพัสดุมาส่งได้ที่ ที่ทำการไปรษณีย์ ทั้ง 410 แห่ง</p>
						<br />
						<p><a href="http://fastship.co/helps/thaipost-dropoff/" target="_blank">วิธีการส่งที่จุด DROP OFF ไปรษณีย์ไทย</a></p>
						<br />
						
                        <p>ในช่วงเวลา <span class="green">วันจันทร์ - ศุกร์ </span> เวลา 08.00-16.00 น.</p>
                        <p>และ <span class="green">วันเสาร์</span> เวลา 08.00-12.00 น. (<span class="red">วันอาทิตย์ปิดทำการ</span>)</p>
						<br />
						<p>ลูกค้าต้องทำรายการในระบบให้เรียบร้อย ก่อนเข้าไปฝากพัสดุที่ไปรษณีย์ <u>อย่างน้อย 2 ชั่วโมง</u></p> 
                        <br />
        ...
        <div class="modal fade" id="ModalB24" tabindex="-1" role="dialog" aria-labelledby="ModalB24_Label" aria-hidden="true">
        	<div class="modal-dialog">
            	<div class="modal-content">
                	<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title text-left" id="ModalSKB_Label">ส่งที่ Box24 อย่างไร ?</h4>
                	</div>
                	<div class="modal-body text-center">
						<p>ลูกค้าสามารถนำพัสดุมาส่งได้ที่ Box24 ทั้ง 7 สาขา ได้แก่</p>
						<br />
						<p>อโศก , ช่องนนทรี , สนามกีฬาแห่งชาติ</p>
						<p>อนุเสาวรีย์ชัยสมรภูมิ, อารีย์ , หมอชิต , ทองหล่อ</p>
						<br />
            ...
            if($("#coupon_code").val() == "") {
        		...
        		$.post("{{url ('pickup/get_coupon')}}",
        		{
        			...
        			if(data > accountDiscount){
        				...
        				showDiscount();
        				$("#coupon_error").text("ขออภัย คูปองส่วนลดนี้ไม่สามารถใช้ได้");
        				$("#coupon_error").show();
            			$("#discount").html("-" + Math.max(accountDiscount,data));
        			}
        ...
        <?php }else{ ?>
            ...
            <div class="text-center" style="padding-top: 30px;">
                ...
                <a href="{{url ('partner/create-shipment')}}" class="btn btn-lg btn-primary">สร้างพัสดุ</a>
            </div>
        <?php } ?> 

    ...
    <div class="row" style="display: show;">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body row-no-padding">
                    ...
                    <div class="form-group col-md-6">
                        <input name="firstname" type="text" class="form-control" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="80" value="<?php echo $res->RECEIVER_FIRSTNAME; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="firstname-error" class="error-msg"></span></div> 
                    </div>
                    <div class="form-group col-md-6">
                        <input name="lastname" type="text" class="form-control" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="80" value="<?php echo $res->RECEIVER_LASTNAME; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="lastname-error" class="error-msg"></span></div> 
                    </div>
                    <div class="form-group col-md-6">
                        <input name="phonenumber" type="text" class="form-control" maxlength="50" value="<?php echo $res->RECEIVER_PHONE; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="phonenumber-error" class="error-msg"></span></div>
                    </div>
                    <div class="form-group col-md-6">
                        <input name="email" type="text" class="form-control" maxlength="50" value="<?php echo $res->RECEIVER_EMAIL; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="email-error" class="error-msg"></span></div>
                    </div>
                    <div class="form-group col-md-12">
                        <input name="company" type="text" class="form-control input-count"  pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="100" value="<?php echo $res->RECEIVER_COMPANY; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="company-error" class="error-msg"></span></div>
                    </div>
                    <div class="form-group col-md-12">
                        <input name="address1" placeholder="Address" type="text" class="form-control" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="80" value="<?php echo $res->RECEIVER_ADDRESS_1; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="address1-error" class="error-msg"></span></div>
                    </div>
                    <div class="form-group col-md-12">
                        <input name="address2" placeholder="Address (cont.)" type="text" class="form-control input-count" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="80" value="<?php echo $res->RECEIVER_ADDRESS_2; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="address2-error" class="error-msg"></span></div>
                    </div>

                    <div class="form-group col-md-6">
                        <input type="text" name="city_post" id="city_post" class="form-control" value="<?php echo $res->RECEIVER_CITY; ?>" readonly>
                    </div>
                     
                    <div class="form-group col-md-6">
                        <input type="text" name="state_post" id="state_post" class="form-control" value="<?php echo $res->RECEIVER_STATE; ?>" readonly >
                    </div>
                    
                    
                    <div class="form-group col-md-6">
                        <input type="text" name="postcode_post" id="postcode_post" class="form-control" value="<?php echo $res->RECEIVER_POSTCODE; ?>" readonly >
                        <!--<select name="postcode" id="postcode" class="form-control">
                            <option value="">-- Postcode --</option>
                        </select>-->
                    </div> 
                    <div class="form-group col-md-6">
                        <input type="text" name="country_post" id="country_post" class="form-control" value="<?php echo $res->RECEIVER_COUNTRY_CODE; ?>" readonly >
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body row-no-padding">
                    <div class="form-group col-md-6">
                        <input name="sender_firstname" type="text" class="form-control" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="80" value="<?php echo $res->SENDER_FIRSTNAME; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="firstname-error" class="error-msg"></span></div>
                    </div>
                    <div class="form-group col-md-6">
                        <input name="sender_lastname" type="text" class="form-control" pattern="<?php echo $validateEnglish; ?>" oninvalid="this.setCustomValidity('กรุณากรอกข้อมูลเป็นภาษาอังกฤษ')" oninput="setCustomValidity('')" maxlength="80" value="<?php echo $res->SENDER_LASTNAME; ?>" readonly />
                        <div class="red tiny text-left col-md-10 no-padding"><span id="lastname-error" class="error-msg"></span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-hover table-ship">
                        ...
                        <tr id='row<?=$key; ?>'>
                            ...
                            <td><input type="number" min="1" name="amount[<?=$key ?>]" class="form-control" value="<?=$cat->QTY;?>" readonly /></td>
                            <td><input type="number" min="1" name="value[<?=$key ?>]" class="form-control" value="<?=$cat->VALUE;?>" readonly /></td>
        ...
        <div class="text-center btn-create" id="submit-form" ><a href="{{ url ('partner/create/shipment') }}"><button type="submit" name="submit" class="btn btn-lg btn-primary minus-margin">กลับหน้าสร้างพัสดุ</button></a></div>
        <div class="clearfix"></div>
    </div>
</div>

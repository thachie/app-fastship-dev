        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body row-no-padding">
                    ...
                    <div class="form-group col-md-6">
                        <input type="text" name="city_post" id="city_post" class="form-control required input-count" >
                    </div>
                     
                    <div class="form-group col-md-6">
                        <input type="text" name="state_post" id="state_post" class="form-control required input-count" >
                    </div>
                    
                    
                    <div class="form-group col-md-6">
                        <input type="text" name="postcode_post" id="postcode_post" class="form-control required input-count" >
                        <!--<select name="postcode" id="postcode" class="form-control">
                            <option value="">-- Postcode --</option>
                        </select>-->
                    </div> 
                    <div class="form-group col-md-6">
                        <input type="text" name="country_post" id="country_post" class="form-control required input-count" >
                        <div class="col-md-12 no-padding">&nbsp;</div>
                    </div>   
                </div>
            </div>

    ...
    <form id="shipment_form" class="form-horizontal" method="post" action="{{url ('partner/store-shipment')}}">
        ...
        <div class="row">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body row-no-padding" style="padding-bottom: 0px;">
                        ...
                        <div class="form-group col-md-6">
                            <input name="firstname" id="firstname" type="text" placeholder="Firstname" class="form-control required input-count en" maxlength="80" value="" 
                            onkeyup="
                        ...
                        <div class="form-group col-md-6">
                            <input name="lastname" id="lastname" type="text" placeholder="Lastname" class="form-control required input-count en" maxlength="80" value="" 
                            onkeyup="
                              var start = this.selectionStart;
                              var end = this.selectionEnd;
                              this.value = this.value.toUpperCase();
                        ...
                        <div class="form-group col-md-6">
                            <input name="email" id="email" type="text" placeholder="Email" title="Email" class="form-control required input-count en" maxlength="50" value="" />
                        ...
                        <div class="form-group col-md-12">
                            <input name="company" id="company" type="text" placeholder="Company Name" class="form-control input-count en"  maxlength="100" value="" 
                            onkeyup="
                              var start = this.selectionStart;
                              var end = this.selectionEnd;
                              this.value = this.value.toUpperCase();
                        ...
                        <div class="form-group col-md-12">
                            <input name="address1" id="address1" placeholder="Address" placeholder="Street Address" type="text" class="form-control required input-count en" maxlength="80" value=""/>
                        ...
                        <div class="form-group col-md-12">
                            <input name="address2" id="address2" placeholder="Address (cont.)" placeholder="Address (continue)" type="text" class="form-control input-count en" maxlength="80" value="" />
                        ...
                        <div class="form-group col-md-12">
                            <input type="text" name="postcode" id="postcode" class="form-control required input-count" placeholder="Postcode" maxlength="10">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" id="dimension" style="display: none;">
                            ...
                            <div class="col-md-4"><span id="volumnWeight" style="line-height: 40px;">0</span> กรัม</div>
                        </div>
            ...
            <div class="col-md-6" style="padding-top: 40px;">
                    <div class="form-group col-md-12">
                        <div class="text-center btn-create" id="submit-form" style="display: none;"><button type="submit" name="submit" class="btn btn-lg btn-primary minus-margin" style="width: 50%">สร้างพัสดุ</button></div>
                    </div>
                    <div class="clearfix"></div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#address1").on("keypress", function(event) {
            var englishAlphabetAndWhiteSpace = /[a-zA-Z0-9 /+=%&_\.,~?\'\-\#@!$^*()<>{}]+$/g;
            var key = String.fromCharCode(event.which);
            if (englishAlphabetAndWhiteSpace.test(key)) {
                return true;
        ...
        $("#address2").on("keypress", function(event) {
            var englishAlphabetAndWhiteSpace = /[a-zA-Z0-9 /+=%&_\.,~?\'\-\#@!$^*()<>{}]+$/g;
            var key = String.fromCharCode(event.which);
            if (englishAlphabetAndWhiteSpace.test(key)) {
                return true;
        ...
        $("#sender_email").on("keypress", function(event) {
            var englishAlphabetAndWhiteSpace = /[a-zA-Z0-9 /+=%&_\.,~?\'\-\#@!$^*()<>{}]+$/g;
            var key = String.fromCharCode(event.which);
            if (englishAlphabetAndWhiteSpace.test(key)) {
                return true;

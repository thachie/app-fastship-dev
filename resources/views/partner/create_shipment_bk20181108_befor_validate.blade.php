            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body row-no-padding">
                        ...
                        <div class="form-group col-md-6">
                            <input name="sender_phonenumber" id="sender_phonenumber" type="text" placeholder="Phone Number" class="form-control required input-count" maxlength="50" value="" />
...
<script type="text/javascript">
    ...
    $("#shipment_form").submit( function() {
        ...
        if (state == '') {
            error = 1;
            //alert('You should select a state.');
            var nm = $("#state").attr("name");
            alert(nm);
            $(this).addClass("error");
            $('#'+nm+"-error").text("กรุณาเลือกประเทศปลายทาง");

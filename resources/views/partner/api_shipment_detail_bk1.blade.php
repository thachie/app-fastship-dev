        ...
        <div class="col-md-6">
        	<div class="panel panel-primary">
                <div class="panel-body">
                	<h2>Status: <?php echo $ShipmentStatus; ?></h2>

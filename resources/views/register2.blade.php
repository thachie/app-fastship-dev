...
<style>
    ...
    .full-bg{
    background: url('../images/joinus/facebook_join.jpg') no-repeat center center fixed; 
...
<div class="conter-wrapper full-bg" style="min-height: 100%; padding-bottom: 0;">     
<div class="row" style="margin-bottom: 0;">     
    <div class="col-md-6 col-md-offset-1">
        <form name="register_form" class="form-horizontal regis" method="post" action="{{url ('/customer/register')}}">	                        
	        {{ csrf_field() }} 
	        <div class="panel panel-primary" style="background: rgba(255,255,255,0.75);">
	            ...
	            <div class="panel-body" >				
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control required" placeholder="เบอร์โทรศัพท์ " name="telephone" id="telephone"  max="9999999999" maxlength="10" required>
                    </div>  
                    
                    <div class="col-md-12">
                    	<select name="state" class="form-control required" required>
                    		<option value="">----- จังหวัดที่อยู่ -----</option>
                    ...
                    <div class="col-md-6">
                        <select name="for" class="form-control required" required>
                    		<option value="">--- การใช้งานของคุณ ---</option>
                    		<option value="ebay">ขายใน Ebay</option>
                    		<option value="amazon">ขายใน Amazon</option>
                    		<option value="esty">ขายใน Esty</option>
                    		<option value="thaitrade">ขายใน Thaitrade</option>
                    		<option value="sample">ขายในช่องทางอื่น - ส่งตัวอย่างสินค้า</option>
                    		<option value="personal">ส่งให้เพื่อน / ญาติ</option>
                    ...
                    <div class="col-md-6">
                        <select name="behavior" class="form-control required" required>
                    		...
                    		<option value="1_10">ส่งประจำ 1-10 พัสดุต่อเดือน</option>
                    		<option value="11_50">ส่งประจำ 11-50 พัสดุต่อเดือน</option>
                    		<option value="50plus">ส่งประจำ มากกว่า 50 พัสดุต่อเดือน</option>
                    		<option value="0">ส่งครั้งเดียว (ไม่แน่นอน)</option>
                    	</select>
                    </div>
                    ...
                    <input type="hidden" name="referal_code" id="referal_code" value="{{ $referCode }}" />
                    ...
                    <div class="modal-dialog">
						...
						<div class="small text-center">เป็นสมาชิกอยู่แล้ว <a href="{{ url('/') }}">เข้าสู่ระบบ</a></div>
	            </div>
	        </div>
	    </form>
	    ...
	    <div class="white-bg row" style="background: rgba(255,255,255,.8);padding: 40px;">
<h2>FastShip | รับทั่วไทย ส่งไกลทั่วโลก</h2>
<h3><img src="../images/joinus/check-mark.png" style="margin-bottom: 10px;"/> ราคาถูก</h3>
<h3><img src="../images/joinus/check-mark.png" style="margin-bottom: 10px;"/> บริการเข้ารับพัสดุถึงหน้าบ้าน</h3>
<h3><img src="../images/joinus/check-mark.png" style="margin-bottom: 10px;"/> ตรวจสอบสถานะพัสดุได้</h3>


<h2 class="text-primary" style="margin-top: 40px;">สมัครวันนี้รับส่วนลดทันที 100 บาท</h2>
<h5>*เฉพาะลูกค้าที่สมัครและใช้งานครั้งแรกเท่านั้น (จำกัดเพียง 30 สิทธิ์เท่านั้น)</h5>
    ...
    <div class="col-md-4">
    	<div class="panel panel-primary">
	        <div class="panel-body" style="display: none;">
	        	<h2 class="orange">FastShip บริการส่งพัสดุไปต่างประเทศกว่า 200ประเทศทั่วโลก</h2>
                <h4>เพียงสมัครผ่านลิงค์ด้านบน รับส่วนลดทันที 100 บาท</h4>
                <h4>ขอแจ่มๆค้า แบบลูกค้าเห็นแล้วต้องคลิก :)</h4>
	        </div>
	    </div>
	    
	    <?php /* ?><div><img src="../images/joinus/facebook_join.jpg" style="max-width: 100%"/></div> <? */ ?>

...
<div class="conter-wrapper">
    ...
    <form id="shipment_form" name="shipment_form" class="form-horizontal" method="post" action="{{url ('shipment/create_etsytest')}}">
        ...
        <input type="hidden" name="etsy_id" value="{{ $default['etsy_id'] }}" />
        <input type="hidden" name="account" value="{{ $default['account'] }}" />
        <input type="hidden" name="receipt_id" value="{{ $default['receipt_id'] }}" />

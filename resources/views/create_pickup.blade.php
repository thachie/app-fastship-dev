...
<!--                                         </div> -->
                    ...
                    <div class="panel">
                        <div class="panel-heading"><i class="fa fa-file"></i> หลักฐานยืนยันตัวตน</div>
                        <div class="panel-body">
                        	<p>กรุณาอัพโหลดบัตรประชาชน เพื่อยืนยันตัวตนของผู้ส่ง โดยข้อมูลจะต้องตรงกับ User ที่ใช้สมัคร</p>
                        	<div><input type="file" name="document" class="form-control" /></div>
                        	<p class="small text-center text-danger" style="margin:20px auto;">
                        	โดยระบบยืนยันตัวตนดังกล่าว เป็นไปตามมาตรป้องกันและปราบปรามยาเสพติด และของผิดกฎหมายอื่นๆ<br />
                        	ซึ่งมีสาระสำคัญกำหนดให้ผู้ประกอบกิจการขนส่งสินค้าหรือพัสดุภัณฑ์ เป็นสถานประกอบการที่อยู่ภายใต้บังคับของมาตรการป้องกัน<br />
                        	และปราบปรามการกระทำความผิดเกี่ยวกับยาเสพติดในสถานประกอบการ และต้องให้ความร่วมมือดำเนินการ<br />

                        ...
                        <tbody>
                          <tr>
                            <td class="column_cell px py text_white text_center" style="vertical-align: top;color: #ffffff;text-align: center;padding-top: 16px;padding-bottom: 16px;padding-left: 16px;padding-right: 16px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                              <h2 class="mb_xs" style="color: inherit;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 8px;word-break: break-word;font-size: 28px;line-height: 38px;font-weight: bold;">เลขที่พัสดุ: {{ $ShipmentID }}</h2>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          <tr>
                            <td class="column_cell px text_dark text_right mobile_center" style="vertical-align: top;color: #333333;text-align: right;padding-left: 16px;padding-right: 16px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                              <p class="mb_xs" style="color: inherit;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 8px;word-break: break-word;font-size: 16px;line-height: 26px;">น้ำหนักรวม &nbsp;<strong style="font-weight: bold;">{{ $Weight }}</strong></p>
							  <p class="mb_xs" style="color: inherit;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 8px;word-break: break-word;font-size: 16px;line-height: 26px;">ประเทศปลายทาง &nbsp;<strong style="font-weight: bold;">{{ $Receiver_Country }}</strong></p>
                            </td>
                          </tr>
                        </tbody>
                      </table>

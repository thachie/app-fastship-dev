...
<div class="conter-wrapper" style="min-height: 500px; padding-bottom: 0; background-image:url(../images/joinus/AmazonFS.jpg); background-size: cover; height: 100%" >     
        ...
        <form name="register_form" class="form-horizontal regis" method="post" action="{{url ('/customer/register')}}">	                        
	        ...
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body">				
                    ...
                    <div class="col-md-6">
                        <input type="hidden" class="form-control" placeholder="รหัสอ้างอิง" name="referal_code" id="referal_code" value="FSXAMZ" />
                    </div>
                    ...
                    สำหรับลูกค้าที่เป็นสมาชิก FastShip แล้ว กรุณากรอกรายละเอียด <a href="https://www.cognitoforms.com/FastShipco/FastShipXAmazon">ที่นี่</a>
					</div>
                    <div class="clearfix"></div><br />
	            </div>
	        </div>

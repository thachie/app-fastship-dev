...
<div class="conter-wrapper">
	...
	<div class="row">
    <form id="payment_form" class="form-horizontal" method="post" action="{{url ('thaipost/import_barcode')}}" enctype="multipart/form-data">
		{{ csrf_field() }}
        ...
        <div class="col-md-6 col-md-offset-3">
        	<div class="panel panel-primary">
				<div class="panel-heading">Import Barcode</div>

...
<div class="row" style="margin-bottom: 0;">     
        ...
        <form name="register_form" class="form-horizontal regis" method="post" action="{{url ('/customer/register')}}">	                        
	        ...
	        <div class="panel panel-primary" style="background: rgba(255,255,255,0.8);">
	            ...
	            <div class="panel-body" >				
                    ...
                    <input type="hidden" name="referral" id="referral" value="from_payoneer" />
    ...
    <div class="col-md-5"> 
    	<div><img src="{{ url('images/fs_payoneer.jpg') }}" style="max-width: 100%"/></div>
    </div>
    
    <div class="white-bg row" style="background: rgba(255,255,255,.8);padding: 40px;">
    	<div class="col-md-10 col-md-offset-1"> 
	    	<h2>เงื่อนไข</h2>
	    	<h4><span class="fa fa-circle small"></span> เฉพาะลูกค้าที่ลงทะเบียนสมัครสมาชิกผ่านลิงค์นี้เท่านั้น</h4>
            <h4><span class="fa fa-circle small"></span> ระยะเวลาตั้งแต่วันที่ 1 -29 กุมภาพันธ์ 2563</h4>
            <h4><span class="fa fa-circle small"></span> จำกัด 20 คนแรกเท่านั้น</h4>
            <h4><span class="fa fa-circle small"></span> ส่วนลดค่าขนส่งมูลค่า 10,000 บาท โดยจะแบ่งเป็น 10 ใบ มูลค่าใบละ 1,000 บาท</h4>
            <h4><span class="fa fa-circle small"></span> ส่วนลดค่าขนส่งสามารถใช้ได้ตั้งแต่วันที่ 1-29 กุมภาพันธ์ 2563 เท่านั้น</h4>
            <h4><span class="fa fa-circle small"></span> ส่วนลดค่าขนส่งไม่สามารถเปลี่ยนเป็นเงินสดหรือของรางวัลอย่างอื่นได้</h4>
            <h4><span class="fa fa-circle small"></span> ขอสงวนสิทธิ์ในการเปลี่ยนแปลงเงื่อนไขโดยมิต้องแจ้งให้ทราบล่วงหน้า</h4>
            <h4><span class="fa fa-circle small"></span> เงื่อนไขเป็นไปตามที่บริษัทกำหนด</h4>
        </div>
    </div>
</div>
</div>

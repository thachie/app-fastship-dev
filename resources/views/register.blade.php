...
<div class="row" style="margin-bottom: 0;">     
    <div class="col-md-6 col-md-offset-1">
        <form name="register_form" class="form-horizontal regis" method="post" action="{{url ('/customer/register')}}">	                        
	        ...
	        <div class="panel panel-primary">
	            <div class="panel-heading">{!! FT::translate('register.panel.heading') !!}</div>
    ...
    <div class="col-md-4">
    	<div class="panel panel-primary">
	        <div class="panel-body">
	        	<h2 class="orange">{!! FT::translate('register.content.heading') !!}</h2>
    ...
    <div style="position: static;right:10px;bottom: 0;"><img src="../images/joinus/FS-team.png" /></div>

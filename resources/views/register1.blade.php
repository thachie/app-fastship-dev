        ...
        <form name="register_form" class="form-horizontal regis" method="post" action="{{url ('/customer/register')}}">	                        
	        ...
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body">				
                    ...
                    @if(!isset($code))
                    <!-- <div class="row"> -->
                        <!-- <div class="col-md-12" style="margin-top: 10px;">กรอกรหัสผู้แนะนำ (referal code) เพื่อรับสิทธิประโยชน์ (ถ้ามี)</div> -->
                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="รหัสอ้างอิง" name="referal_code" id="referal_code" value="<?php echo $referCode; ?>" />
                        </div>
                    <!-- </div> -->
                    @else
                    	<input type="hidden" name="referal_code" id="referal_code" value="<?php echo $referCode; ?>" />
                    @endif
